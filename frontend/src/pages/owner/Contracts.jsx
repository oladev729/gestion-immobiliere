...
const Contracts = () => {
    ...
    const openContratView = async (c) => {
        try {
            const idContrat = c.id_contact || c.id_contrat;
            const response = await api.get(`/contrats/${idContrat}`);
            const completeContrat = response.data;
            
            printContrat(
                completeContrat,
                completeContrat.bien || biens.find(b => b.id_bien == c.id_bien) || {},
                completeContrat.locataire || locataires.find(l => l.id_locataire === c.id_locataire) || {},
